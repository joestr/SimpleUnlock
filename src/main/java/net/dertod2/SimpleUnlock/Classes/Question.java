...
public class Question extends TableEntry {
	...
	public int getMaxChances() {
		int chances = (int) ((this.answerOptions.size() * SimpleUnlock.getConfiguration().getDouble("chances-mod")) / 100);
		
		if (chances < SimpleUnlock.getConfiguration().getInt("min-chances")) chances = SimpleUnlock.getConfiguration().getInt("min-chances");
		if (chances > SimpleUnlock.getConfiguration().getInt("max-chances")) chances = SimpleUnlock.getConfiguration().getInt("max-chances");
